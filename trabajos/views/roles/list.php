<main class="container">
	<section class="col-md-12 text-center">
		...
		<div class="col-md-12 m-4 d-flex justify-content-between">
			...
			<a href="?controller=rol&method=add" class="btn btn-warning">Agregar</a>
		</div>
				...
				<tbody>
					<?php foreach($roles as $rol): ?>
						<tr>
							...
							<td>
								<a href="?controller=rol&method=edit&id=<?php echo $rol->id?>" class="btn btn-success" title="Editar Rol">Editar</a>
