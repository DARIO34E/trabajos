<main class="container">
	<section class="col-md-12 text-center">
		...
		<div class="col-md-12 m-4 d-flex justify-content-between">
			...
			<a href="?controller=status&method=add" class="btn btn-warning">Agregar</a>
		</div>
				...
				<tbody>
					<?php foreach($statuses as $status): ?>
						<tr>
							...
							<td>
								<a href="?controller=status&method=edit&id=<?php echo $status->id?>" class="btn btn-success" title="Editar estado">Editar</a>
