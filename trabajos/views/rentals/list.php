<main class="container">
	<section class="col-md-12 text-center">
		...
		<div class="col-md-12 m-4 d-flex justify-content-between">
			...
			<a href="?controller=rental&method=add" class="btn btn-warning">Agregar</a>
		</div>
				...
				<tbody>
					<?php foreach($rentals as $rental): ?>
						<tr>
							...
							<td>
								<a href="?controller=rental&method=edit&id=<?php echo $rental->id?>" class="btn btn-success" title="Editar Renta">Editar</a>
								<a href="?controller=rental&method=delete&id=<?php echo $rental->id?>" class="btn btn-danger" title="Eliminar Renta">Eliminar</a>
								<a href="?controller=rental&method=seeMovies&id=<?php echo $rental->id?>" class="btn btn-primary" >películas</a>
							</td>
						</tr>
