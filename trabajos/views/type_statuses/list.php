<main class="container">
	<section class="col-md-12 text-center">
		...
		<div class="col-md-12 m-4 d-flex justify-content-between">
			...
			<a href="?controller=typestatus&method=add" class="btn btn-warning">Agregar</a>
		</div>
				...
				<tbody>
					<?php foreach($typeSt as $tstatus): ?>
						<tr>
							...
							<td>
								<a href="?controller=TypeStatus&method=edit&id=<?php echo $tstatus->id?>" class="btn btn-success" title="Editar tipo de estado">Editar</a>
